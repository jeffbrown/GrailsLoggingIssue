...
## Issue
When using the `grails-logging` plugin, we cannot use the Spring Boot `loggers` actuator endpoint to use a 
Log4J2 log level that has been dynamically set. Static Log4J2 logger configuration works fine.  
